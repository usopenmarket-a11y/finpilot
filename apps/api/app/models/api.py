...
class BankAccountUpdate(BaseModel):
    ...
    account_type: Optional[str] = Field(default=None, description="Updated account type")
    currency: Optional[str] = Field(default=None, description="Updated currency code")
    is_active: Optional[bool] = Field(default=None, description="Toggle active/inactive sync")
...
class DebtCreate(BaseModel):
    ...
    counterparty_phone: Optional[str] = Field(default=None, description="Contact phone number")
    counterparty_email: Optional[str] = Field(default=None, description="Contact email")
...
class DebtPaymentCreate(BaseModel):
    ...
    notes: Optional[str] = Field(default=None, description="Optional payment memo")
