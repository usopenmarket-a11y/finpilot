...
- Saved to packages/shared/src/types/database.ts
- Convenience aliases exported (BankAccountRow, TransactionRow, etc.)
- Package name: @finpilot/shared
