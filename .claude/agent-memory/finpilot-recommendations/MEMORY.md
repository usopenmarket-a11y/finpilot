...
- [Continuous health score formula (2026-06-15)](project_health_score_formula.md) — Replaced the old flat-penalty health_score with a 3-component weighted blend (savings rate/trend/concentration) and gave action items real EGP estimated_impact; old HEALTH_PENALTY_* constants removed
